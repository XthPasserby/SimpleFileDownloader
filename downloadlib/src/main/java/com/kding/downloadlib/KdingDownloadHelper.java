 ...
 */
public class KdingDownloadHelper<T extends DownloadItem> {
    private static KdingDownloadHelper instance = null;
    private static OkHttpClient mHttpClient = null;
    private static DownloadDBManger dbManger;
     ...
     */
    static KdingDownloadHelper getInstance() {
        if (null == instance) {
            synchronized (KdingDownloadHelper.class) {
                if (null == instance) {
                    instance = new KdingDownloadHelper<>();
                }
            }
        }
